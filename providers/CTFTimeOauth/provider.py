...
class CTFTimeOauth2Account(ProviderAccount):
    ...
    def get_profile_url(self):
        ...
        if username:
            return "https://ctftime.com/" + username
        return None
    ...
    def to_str(self):
        username = self.get_username()
        return username or super(CTFTimeOauth2Account, self).to_str()


class CTFTimeOauth2AProvider(OAuth2Provider):
    id = "ctftime_oauth2"
    name = "CTFTime"
    account_class = CTFTimeOauth2Account
    oauth2_adapter_class = CTFTimeOauth2Adapter
