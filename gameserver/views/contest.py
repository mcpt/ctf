...
class ContestDetail(
    ...
    def form_valid(self, form):
        if (
            ...
            if team is not None:
                contest_participation = models.ContestParticipation.objects.get_or_create(team=team, contest=contest)[0]
            else:
                try:
            ...
            if contest_participation.participants.count() == contest.max_team_size:
                return HttpResponseBadRequest("This team is already full. Please choose another team.")
