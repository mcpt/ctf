# Based on https://github.com/DMOJ/online-judge/blob/master/judge/jinja2/markdown/bleach_whitelist.py , which is, in turn, based on https://github.com/yourcelf/bleach-whitelist/blob/master/bleach_whitelist/bleach_whitelist.py
...
standard_styles = [
    ...
    'linear-gadient()', 'line-break', 'line-height', ':link', 'list-style',
